 ...
 */
final class Version20220218105407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, receiver_id INT NOT NULL, sender_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_723705D1CD53EDB6 (receiver_id), INDEX IDX_723705D1F624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
